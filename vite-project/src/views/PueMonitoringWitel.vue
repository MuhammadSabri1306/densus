...
setTimeout(() => pueStore.fetchOnWitel(witelCode.value, false, () => isLoading.value = false), 1000);

pueStore.setCurrentZone({ witel: witelCode.value });
    ...
    <div>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <DashboardBreadcrumb :items="['Monitoring PUE', 'PUE Online', 'Witel']" class="ms-4" />
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid dashboard-default-sec">
            <div class="row align-items-end">
                <div class="col-md-4">
                    <CardPueRtuInfo v-if="requestLevel" :data="requestLevel" />
                    <CardPueCurrent />
