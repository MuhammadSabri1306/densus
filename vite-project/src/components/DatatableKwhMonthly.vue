...
const setSrcData = data => {
    resetCollapse();
    if(data.month_column)
        monthColumn.value = data.month_column;
    if(data.kwh_data)
        ...
        <table class="table table-bordered table-head-primary table-collapsable">
            <thead>
                <tr>
                    ...
                    <th class="bg-success" :colspan="monthColumn.length">{{ titleYear }}</th>
                </tr>
                <tr>
                    <th class="bg-success" :colspan="monthColumn.length">Monitoring Nilai KwH</th>
                </tr>
                <tr>
                    <th v-for="month in monthColumn" class="text-center">{{ month }}</th>
                </tr>
            </thead>
            <tbody>
