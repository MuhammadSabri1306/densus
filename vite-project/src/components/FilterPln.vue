...
onMounted(() => {
    if(currUser.value.level == "divre") {
        ...
        if(viewStore.filters.divre) {
            ...
            listboxWitel.value.fetch(() => viewStore.getWitelByDivre(viewStore.filters.divre, "gepee"));
        }
        if(viewStore.filters.witel)
            listboxWitel.value.setValue(viewStore.filters.witel);
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <ListboxFilter ref="listboxDivre" inputId="inputDivre" inputPlaceholder="Pilih Divre"
                                        :isRequired="requireDivre" valueKey="divre_kode" labelKey="divre_name" useResetItem resetTitle="Pilih Semua"
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <ListboxFilter ref="listboxWitel" inputId="inputWitel" inputPlaceholder="Pilih Witel"
                                        :isRequired="requireWitel" valueKey="witel_kode" labelKey="witel_name" useResetItem resetTitle="Pilih Semua"
