...
const { data, v$ } = useDataForm({
    ...
    witel_kode: { required },
    witel_name: { required },
    genset_merk: { required },
    genset_type: { required },
    genset_daya: { required, numeric }
});
...
<template>
    ...
    <div class="row gx-5">
        ...
        <div class="col-12 col-md-8">
            <div class="mb-4">
                <label for="inputGensetMerk" class="required">Merk Genset</label>
                <input type="text" v-model="v$.genset_merk.$model" id="inputGensetMerk" :class="{ 'is-invalid': hasSubmitted && v$.genset_merk.$invalid }" class="form-control" placeholder="" />
            </div>
        </div>
        <div class="col-12 col-md-4">
            <div class="mb-4">
                <label for="inputGensetType" class="required">Tipe Genset</label>
                <input type="text" v-model="v$.genset_type.$model" id="inputGensetType" :class="{ 'is-invalid': hasSubmitted && v$.genset_type.$invalid }" class="form-control" placeholder="" />
            </div>
        </div>
        <div class="col-12 col-md-6">
            <div class="mb-4">
                <label for="inputGensetDaya" class="required">Daya Genset</label>
                <input type="text" v-model="v$.genset_daya.$model" id="inputGensetDaya" :class="{ 'is-invalid': hasSubmitted && v$.genset_daya.$invalid }" class="form-control" placeholder="" />
            </div>
        </div>
    </div>
</template>