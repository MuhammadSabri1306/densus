        ...
        <table class="table table-bordered table-head-primary table-collapsable">
            <thead>
                <tr>
                    ...
                    <th class="bg-success" :colspan="weekColumn.length">{{ titleMonthYear }}</th>
                </tr>
                <tr>
                    <th class="bg-success" :colspan="weekColumn.length">Monitoring Nilai KwH</th>
                </tr>
                <tr>
                    <th v-for="week in weekColumn" class="text-center">{{ week }}</th>
                </tr>
            </thead>
            <tbody>
