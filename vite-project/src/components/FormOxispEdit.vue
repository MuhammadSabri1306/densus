...
const oxispId = computed(() => props.initData?.id || null);
const { data, v$ } = useDataForm({
    title: { value: props.initData.title, required },
    descr: { value: props.initData.descr, required },
    descr_before: { value: props.initData.descr_before, required },
    descr_after: { value: props.initData.descr_after, required },
...
const onSave = async () => {
    ...
    oxispStore.update(oxispId.value, body, response => {
...
<template>
    <form @submit.prevent="onSave">
        ...
        <FileUpload isRequired url="/attachment/oxisp" :uploadedFile="uploadedFile" label="File Evidence"
