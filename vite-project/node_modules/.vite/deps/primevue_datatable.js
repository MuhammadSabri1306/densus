  ...
  return ($props.alwaysShow ? true : $options.pageLinks && $options.pageLinks.length > 1) ? (openBlock(), createElementBlock("nav", _hoisted_19, [
    (openBlock(true), createElementBlock(Fragment, null, renderList($options.templateItems, (value, key) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.$slots.start ? (openBlock(), createElementBlock("div", _hoisted_23, [
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    _ctx.$slots.header ? (openBlock(), createElementBlock("div", _hoisted_24, [
      renderSlot(_ctx.$slots, "header")
    ])) : createCommentVNode("", true),
