...
/* 
 *
 * SEMUA METHOD CRUD PER ITEM PINDAH, 
 * MASING2 DIBUATKAN CONTROLLER BARU.
 * INI UTK FUNCTIONALITY DASHBOARD
 *
 */

class Monitoring_energy extends RestController
{
    ...
    /* ------------------------------ PLN Bill Location ------------------------------ */
    public function pln_bill_location_get()
    {
    ...
    public function pln_bill_location_post()
    {
    ...
    public function pln_bill_location_put($id)
    {
		$status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_bill_location_delete($id)
	{
        $status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_bill_put($id)
    {
		$status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_bill_delete($id)
	{
        $status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    /* ------------------------------ PLN Parameters ------------------------------ */
    public function pln_params_get()
    {
        $status = $this->auth_jwt->auth('admin', 'viewer', 'teknisi');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_params_post()
    {
        $status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_params_put($id)
    {
        $status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
    ...
    public function pln_params_delete($id)
    {
        $status = $this->auth_jwt->auth('admin');
        switch($status) {
            case REST_ERR_EXP_TOKEN_STATUS: $data = REST_ERR_EXP_TOKEN_DATA; break;
