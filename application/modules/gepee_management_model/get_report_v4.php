...
$hasNewCounterQuery = 'IF(EXISTS(SELECT 1 FROM pue_counter_new AS pue2 WHERE pue2.rtu_kode=pue.rtu_kode), 1, 0)';
$this->db
    ->select("rtu.id_lokasi_gepee, rtu.rtu_kode, pue.pue_value, pue.timestamp, $targetLocQuery AS is_target, $hasNewCounterQuery AS has_new_counter")
...
$this->db
    ->select("rtu.id_lokasi_gepee, rtu.rtu_kode, pue.pue_value, pue.timestamp, $targetLocQuery AS is_target")
