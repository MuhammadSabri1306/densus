...
while($startDateCol <= $endDateCol) {
    $dateColsTemp[$startDateCol->format('d')] = null;
...
$this->result = [
    'kwh_data' => $kwhData,
    'day_column' => array_map(function($dayItem) {
        return (string) $dayItem;
    }, array_keys($dateColsTemp))
];