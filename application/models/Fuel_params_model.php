<?php
class Fuel_params_model extends CI_Model
{
    private $tableName = 'fuel_params';
    public $currUser;
    private $fillable_fields = [
        'static' => [
            ...
            'genset_merk' => ['string', 'required'],
            'genset_type' => ['string', 'required'],
            'genset_daya' => ['int', 'required']
        ],
        'updatable' => [
            'port_deg_10' => ['string', 'required'],
            'port_deg_11' => ['string', 'required'],
            'port_deg_20' => ['string', 'required'],
            'port_deg_21' => ['string', 'required'],
            'port_status_genset' => ['string', 'required'],
            'port_status_pln' => ['string', 'required']
        ]
    ];
